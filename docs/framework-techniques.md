...
| E10 | 天空、植被、水、折射、荧光棒等专用表面；PPT 109 | 默认关闭的 [独立水面](scene-water.md)、[自主天空](scene-sky.md) 与 [观众荧光棒](crowd-lightsticks.md)：自制遮罩、实例颜色／显式时钟实际进入 Crowd 当前蒙皮和四视图；原六面 HDR／mip 反射及水面 Cubemap 字段保留 | 自制桌面整图、实际天空捕获／反射消费、水面蒙皮／深度／光照与荧光棒独立遮罩／当前实例有对照；植被、钻石折射、完整制作水面／观众、相交介质／时域和移动成本仍待完成。资料只列专用用途，未公开对应算法，不假定原版参数或整体画质一致 |
