...
| E10 | 天空、植被、水、折射、荧光棒等专用表面；PPT 109 | 默认关闭的 [独立水面](scene-water.md)、[自主天空](scene-sky.md)、[观众荧光棒](crowd-lightsticks.md)、[当前植被风场](vegetation-wind.md)；新增 [薄叶材质](vegetation-leaf.md)：自制厚度／吸收、双面法线及漫反射／透射分配，接入 Deferred／Forward+ 的当前 GI、Monitor、主光／局部灯与阴影 | 自制桌面植被几何、薄叶光照与专用独立附件有对照；钻石折射、完整制作植被／水面／观众、复杂相交／折射介质、其他专用消费者与移动成本仍待完成。资料只列用途，未公开对应算法，不假定原版参数或整体画质一致 |
