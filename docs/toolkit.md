...
| 可选 ScreenShadow／环境遮蔽 | `SceneScreenShadowSettings`；显式几何预通道、RG8 主灯／环境可见性和世界胶囊半球积分；可选 `SceneGtaoSettings` 提供视轴 horizon 积分，默认关闭，见 [数据流](scene-screen-shadow.md) 与 [GTAO](scene-gtao.md) |
