    ...
    public sealed partial class ActorRenderingSelfTest : MonoBehaviour
    {
        ...
        private IEnumerator Start()
        {
            ...
            try
            {
                ...
                SetUp();
                if(Array.IndexOf(Environment.GetCommandLineArgs(),"--self-test-disabled-colliders-only")>=0)
                {
                    VerifyDisabledDynamicColliders(report);
                    report.accepted=report.checks.TrueForAll(check=>check.accepted);
                    File.WriteAllText(Path.Combine(_directory,"actor-synthetic.json"),JsonUtility.ToJson(report,true));
                    Debug.Log("[ActorSelfTest] accepted="+report.accepted+"; checks="+report.checks.Count);
                    Application.Quit(report.accepted?0:2);yield break;
                }
                if(Array.IndexOf(Environment.GetCommandLineArgs(),"--self-test-garment-slide-only")>=0)
                {
                    VerifyGarmentSlideTranslation(report);
                    report.accepted=report.checks.TrueForAll(check=>check.accepted);
                    File.WriteAllText(Path.Combine(_directory,"actor-synthetic.json"),JsonUtility.ToJson(report,true));
                    Debug.Log("[ActorSelfTest] accepted="+report.accepted+"; checks="+report.checks.Count);
                    Application.Quit(report.accepted?0:2);yield break;
                }
                if(Array.IndexOf(Environment.GetCommandLineArgs(),"--self-test-skirt-helpers-only")>=0)
                {
                    VerifyAuthoredSkirtHelpers(report);
                    report.accepted=report.checks.TrueForAll(check=>check.accepted);
                    File.WriteAllText(Path.Combine(_directory,"actor-synthetic.json"),JsonUtility.ToJson(report,true));
                    Debug.Log("[ActorSelfTest] accepted="+report.accepted+"; checks="+report.checks.Count);
                    Application.Quit(report.accepted?0:2);yield break;
            ...
            {
                _owned.Clear();
                var fixture = VerifySceneMainShadows(report);
                while (true)
                {
                    bool more; object next = null;
                    try { more = fixture.MoveNext(); if (more) next = fixture.Current; }
            ...
            {
                _owned.Clear();
                var fixture = VerifyScenePointShadows(report);
                while (true)
                {
                    bool more; object next = null;
                    try { more = fixture.MoveNext(); if (more) next = fixture.Current; }
            ...
            {
                _owned.Clear();
                var fixture = VerifySceneScreenShadows(report);
                while (true)
                {
                    bool more; object next = null;
                    try { more = fixture.MoveNext(); if (more) next = fixture.Current; }
            ...
            {
                _owned.Clear();
                var fixture = VerifySceneGtao(report);
                while (true)
                {
                    bool more; object next = null;
                    try { more = fixture.MoveNext(); if (more) next = fixture.Current; }
            ...
            {
                _owned.Clear();
                var fixture = VerifySceneGtaoSpatial(report);
                while (true)
                {
                    bool more; object next = null;
                    try { more = fixture.MoveNext(); if (more) next = fixture.Current; }
            ...
            {
                _owned.Clear();
                var fixture = VerifySceneMotion(report);
                while (true)
                {
                    bool more; object next = null;
                    try { more = fixture.MoveNext(); if (more) next = fixture.Current; }
            ...
            {
                _owned.Clear();
                var fixture = VerifySceneGtaoTemporal(report);
                while (true)
                {
                    bool more; object next = null;
                    try { more = fixture.MoveNext(); if (more) next = fixture.Current; }
            ...
            {
                _owned.Clear();
                var fixture = VerifySceneTaa(report);
                while (true)
                {
                    bool more; object next = null;
                    try { more = fixture.MoveNext(); if (more) next = fixture.Current; }
            ...
            {
                _owned.Clear();
                var fixture = VerifyBokeh(report);
                while (true)
                {
                    bool more; object next = null;
                    try { more = fixture.MoveNext(); if (more) next = fixture.Current; }
            ...
            {
                _owned.Clear();
                var fixture = VerifyColorGrading(report);
                while (true)
                {
                    bool more; object next = null;
                    try { more = fixture.MoveNext(); if (more) next = fixture.Current; }
            ...
            {
                _owned.Clear();
                var fixture = VerifyMotionBlur(report);
                while (true)
                {
                    bool more; object next = null;
                    try { more = fixture.MoveNext(); if (more) next = fixture.Current; }
            ...
            {
                _owned.Clear();
                var fixture = VerifyFogVolumes(report);
                while (true)
                {
                    bool more; object next = null;
                    try { more = fixture.MoveNext(); if (more) next = fixture.Current; }
            ...
            {
                _owned.Clear();
                var fixture = VerifyVolumetricLighting(report);
                while (true)
                {
                    bool more; object next = null;
                    try { more = fixture.MoveNext(); if (more) next = fixture.Current; }
            ...
            {
                _owned.Clear();
                var fixture = VerifyLowResolutionFx(report);
                while (true)
                {
                    bool more; object next = null;
                    try { more = fixture.MoveNext(); if (more) next = fixture.Current; }
            ...
            {
                _owned.Clear();
                var fixture = VerifyHeavyFx(report);
                while (true)
                {
                    bool more; object next = null;
                    try { more = fixture.MoveNext(); if (more) next = fixture.Current; }
            ...
            {
                _owned.Clear();
                var fixture = VerifyAuthoredFaceDecals(report);
                while (true)
                {
                    bool more; object next = null;
                    try { more = fixture.MoveNext(); if (more) next = fixture.Current; }
            ...
            {
                _owned.Clear();
                var fixture = VerifyMotionEffects(report);
                while (true)
                {
                    bool more; object next = null;
                    try { more = fixture.MoveNext(); if (more) next = fixture.Current; }
            ...
            {
                _owned.Clear();
                var fixture = VerifyVertexLocators(report);
                while (true)
                {
                    bool more; object next = null;
                    try { more = fixture.MoveNext(); if (more) next = fixture.Current; }
            ...
            {
                _owned.Clear();
                var fixture = VerifyPerformanceAuthoring(report);
                while (true)
                {
                    bool more; object next = null;
                    try { more = fixture.MoveNext(); if (more) next = fixture.Current; }
            ...
            {
                _owned.Clear();
                var fixture = VerifyForwardPlus(report);
                while (true)
                {
                    bool more; object next = null;
                    try { more = fixture.MoveNext(); if (more) next = fixture.Current; }
            ...
            {
                _owned.Clear();
                var fixture = VerifyFxForward(report);
                while (true)
                {
                    bool more; object next = null;
                    try { more = fixture.MoveNext(); if (more) next = fixture.Current; }
            ...
            {
                _owned.Clear();
                var fixture = VerifyCrowd(report);
                while (true)
                {
                    bool more; object next = null;
                    try { more = fixture.MoveNext(); if (more) next = fixture.Current; }
            ...
            {
                _owned.Clear();
                var fixture = VerifyFsrCamera(report);
                while (true)
                {
                    bool more; object next = null;
                    try { more = fixture.MoveNext(); if (more) next = fixture.Current; }
            ...
            {
                _owned.Clear();
                var fixture = VerifyWater(report);
                while (true)
                {
                    bool more; object next = null;
                    try { more = fixture.MoveNext(); if (more) next = fixture.Current; }
            ...
            {
                _owned.Clear();
                var fixture = VerifyOutlineAuthoring(report);
                while (true)
                {
                    bool more; object next = null;
                    try { more = fixture.MoveNext(); if (more) next = fixture.Current; }
            ...
            {
                _owned.Clear();
                var fixture = VerifyForwardBasis(report);
                while (true)
                {
                    bool more; object next = null;
                    try { more = fixture.MoveNext(); if (more) next = fixture.Current; }
            ...
            {
                _owned.Clear();
                var fixture = VerifyBakedMask(report);
                while (true)
                {
                    bool more; object next = null;
                    try { more = fixture.MoveNext(); if (more) next = fixture.Current; }
            ...
            {
                _owned.Clear();
                var fixture = VerifySceneSky(report);
                while (true)
                {
                    bool more; object next = null;
                    try { more = fixture.MoveNext(); if (more) next = fixture.Current; }
            ...
            {
                _owned.Clear();
                var fixture = VerifyCrowdLightsticks(report);
                while (true)
                {
                    bool more; object next = null;
                    try { more = fixture.MoveNext(); if (more) next = fixture.Current; }
            ...
            {
                _owned.Clear();
                var fixture = VerifyVegetationWind(report);
                while (true)
                {
                    bool more; object next = null;
                    try { more = fixture.MoveNext(); if (more) next = fixture.Current; }
            ...
            {
                _owned.Clear();
                var fixture = VerifyVegetationLeaf(report);
                while (true)
                {
                    bool more; object next = null;
                    try { more = fixture.MoveNext(); if (more) next = fixture.Current; }
            ...
            {
                _owned.Clear();
                var fixture = VerifyConvexRefraction(report);
                while (true)
                {
                    bool more; object next = null;
                    try { more = fixture.MoveNext(); if (more) next = fixture.Current; }
            ...
            {
                _owned.Clear();
                var fixture = VerifyExtendedSourceShadows(report);
                while (true)
                {
                    bool more; object next = null;
                    try { more = fixture.MoveNext(); if (more) next = fixture.Current; }
            ...
            {
                _owned.Clear();
                var fixture = VerifyCrowdShadows(report);
                while (true)
                {
                    bool more; object next = null;
                    try { more = fixture.MoveNext(); if (more) next = fixture.Current; }
            ...
            if (!string.IsNullOrEmpty(_directory) && Directory.Exists(_directory))
            {
                ...
                if(report.error==null)
                {
                    _owned.Clear();var fixture=VerifyTileDecal(report);
                    while(true)
                    {
                        bool more;object next=null;
                        try { more=fixture.MoveNext();if(more)next=fixture.Current; }
