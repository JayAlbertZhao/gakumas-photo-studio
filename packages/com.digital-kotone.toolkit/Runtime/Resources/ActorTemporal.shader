Shader "Hidden/GakumasPhotoMode/ActorTemporal"
{
    Properties
    {
    ...
    SubShader
    {
        Pass
        {
            Name "ACTOR_FORWARD_TEMPORAL"
            Cull [_Cull] ZWrite [_ZWrite]
            Blend 0 [_SrcBlend] [_DstBlend], [_SrcAlphaBlend] [_DstAlphaBlend]
            Blend 1 Off
            Blend 2 Off
            ColorMask [_ColorMask]
            ColorMask RGBA 1
            ColorMask R 2
            Stencil { Ref [_StencilRef] ReadMask [_StencilReadMask] WriteMask [_StencilWriteMask] Comp [_StencilComp] Pass [_StencilPass] }
            CGPROGRAM
            #pragma target 4.5
        ...
        Pass
        {
            Name "ACTOR_FORWARD_CLIP_SNAPSHOT"
            Cull Off ZWrite Off ZTest Always Blend Off
            CGPROGRAM
            #pragma target 4.5
            #pragma vertex SnapshotVertex
            #pragma geometry SnapshotGeometry
            #pragma require geometry
            #pragma fragment SnapshotFragment
            #include "ActorTemporal.cginc"
            ENDCG
        }
        Pass
        {
            Name "ACTOR_OUTLINE_TEMPORAL"
            ...
            #pragma vertex TemporalVertex
            #pragma fragment TemporalFragment
            #define TOOLKIT_TEMPORAL_OUTLINE 1
            #include "ActorTemporal.cginc"
            ENDCG
        }
        Pass
        {
            Name "ACTOR_OUTLINE_CLIP_SNAPSHOT"
            Cull Off ZWrite Off ZTest Always Blend Off
            CGPROGRAM
            #pragma target 4.5
            #pragma vertex SnapshotVertex
        ...
        Pass
        {
            Name "ACTOR_HAIR_COVER_TEMPORAL"
            Cull [_Cull] ZWrite [_ZWrite] ZTest LEqual
            Blend 0 SrcAlpha OneMinusSrcAlpha, Zero One
            Blend 1 Off
            Blend 2 Off
            Stencil { Ref [_StencilRef] ReadMask [_StencilReadMask] WriteMask 0 Comp Less Pass Keep }
            CGPROGRAM
            #pragma target 4.5
            #pragma vertex TemporalVertex
            #pragma fragment TemporalFragment
        ...
        Pass
        {
            Name "ACTOR_HAIR_COVER_CLIP_SNAPSHOT"
            Cull Off ZWrite Off ZTest Always Blend Off
            CGPROGRAM
            #pragma target 4.5
            #pragma vertex SnapshotVertex
